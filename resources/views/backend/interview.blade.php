...
<div class="col-12">
    <div class="box">
        <div class="box-header headerpage row">
            <div class="col-lg-8">
                <h3 class="box-title">Liste des Interviews</h3>
            </div>
            <div class="col-lg-4">
                <button class="btn btn-seconday addnew" id="newuser" data-bs-toggle="modal" 
                data-bs-target="#createInterviewModal">Ajouter</button>
            </div>
        </div><br>
        <!-- /.box-header -->
        <div class="box-body">
                        ...
                        @foreach ($allinterview as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="activeitem">Aucune Vidéo</span>
                                    @endif
                                </td>
                                <td>
                                    @if ($item->is_valid == 1)
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                ...
                                                data-id="{{$item->id}}"
                                                data-message="Le status de cet Interview sera mis à jour!"
                                                data-type="warning"
                                                data-url="{{ route ('status-interview')}}"
                                            ...
                                            <li>
                                                ...
                                                data-id="{{$item->id}}"
                                                data-message="Après avoir affectué cette action l'interview sera visible par les visiteurs!"
                                                data-type="success"
                                                data-url="{{ route ('validation-interview')}}"
                                                data-token="{{csrf_token()}}">
                                            ...
                                            <li>
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#updateInterviewModal"
                                                data-id="{{ $item->id }}"
                                                data-title="{{ $item->title }}"
                                                data-label="{{ $item->label }}"
                                                data-description="{{ $item->description }}"
                                            ...
                                            <li>
                                                ...
                                                data-id="{{$item->id}}"
                                                data-message="Cet Interview sera supprimer!"
                                                data-type="warning"
                                                data-url="{{ route ('delete-interview')}}"
                                                data-token="{{csrf_token()}}">
                    ...
                    @else
                        <tr >
                            <td colspan="12" class="text-primary text-center" >
                                <p style="font-size: 14px; margin-top:50px; color:#888">Aucun Interview enregistré pour l'instant!</p>
                            </td>
                        </tr>
                    @endif
                </tbody>
    ...
    <!-- modale ajouter une Interview -->
    <div id="createInterviewModal" class="modal fade" role="dialog">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <div class="form-group label-floating" style="width: 100%;">
                                    <input class="form-control"  name="title" required placeholder="Titre" required />
                                    <hr>
                                </div>
                            </div>
                        </div>
    ...
    <!-- end popup -->
     ...
     <div id="updateInterviewModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="updateform" lpformnum="1"  method="post" enctype="multipart/form-data" onsubmit="postSubmissionUpdate()" action="{{ route ('update-interview')}}">
                    <div class="modal-body">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <p style="color: #888">Titre</p>
                                <div class="form-group label-floating" style="width: 100%;">
                                    <input class="form-control" id="interviewtitle" name="title" placeholder="Titre" />
                                    <hr>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <p style="color: #888">Label</p>
                                <div class="form-group label-floating" style="width: 100%;">
                                    <input type="text" id="interviewlabel" class="form-control" name="label" placeholder="Label" />
                                    <hr>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <p style="color: #888">Catégorie</p>
                                <div class="form-group label-floating" style="width: 100%;">
                                    <select name="category" id="interviewcategory" class="form-control">
                                        <option value="" selected>Selectionner la categorie</option>
                                        @foreach ($allcategory as $item)
                                            <option value="{{$item->id}}">{{$item->title}}</option>
                                        @endforeach
                            ...
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <p style="color: #888">Pays d'Origine</p>
                                <div class="form-group label-floating" style="width: 100%;">
                                    <select name="country" id="interviewcountry" class="form-control">
                                        <option value="" selected>Selectionner le Pays d'origine</option>
                                        @foreach ($allcountry as $item)
                                            <option value="{{$item->id}}">{{$item->name}}</option>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <p style="color: #888">Programme</p>
                                <div class="form-group label-floating" style="width: 100%;">
                                    <select name="program" class="form-control" id="interviewprogram">
                                        <option value="" selected>Selectionner le programme</option>
                                        @foreach ($allprogram as $item)
                                            <option value="{{$item->id}}">{{$item->title}}</option>
                                        @endforeach
                            ...
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <p style="color: #888">Priorité</p>
                                <div class="form-group label-floating" style="width: 100%;">
                                    <select name="priority" class="form-control" id="interviewpriority">
                                        <option value="0">Priorité par défault</option>
                                        <option value="1">Faible</option>
                                        <option value="2">Moyenne</option>
                                        <option value="3">Haute</option>
