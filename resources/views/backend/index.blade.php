                ...
                <div class="col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="fw-medium text-muted mb-0">Durée Visite Moyenne</p>
                ...
                <div class="col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="fw-medium text-muted mb-0">Les Partages</p>
                ...
                <div class="col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="fw-medium text-muted mb-0">Les Likes</p>
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="33">0</span>k</h2>
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0">
                                            <i class="ri-arrow-up-line align-middle"></i> 7.05 k
                                        </span> vs. Mois dernier</p>
                                </div>
                                <div>
                                    <div class="avatar-sm flex-shrink-0">
                ...
                <div class="col-md-6">
                    <div class="card card-animate">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <p class="fw-medium text-muted mb-0">Publicités en vues</p>
                                    <h2 class="mt-4 ff-secondary fw-semibold"><span class="counter-value" data-target="20">0</span>Diff</h2>
                                    <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0">
                                            <i class="ri-arrow-up-line align-middle"></i> 20 Diffusions
                                        </span> vs. Mois dernier</p>
                                </div>
                                <div>
                                    <div class="avatar-sm flex-shrink-0">
    ...
    <div class="col-xxl-7">
        <div class="row h-100">
            <div class="col-xl-6">
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Utilisateurs en live par Pays</h4>
            ...
            <div class="col-xl-6">
                <div class="card card-height-100">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Sessions Ouvertes / Pays</h4>
                        <div>
